...
public class JwtTokenProvider {
    ...
    public JwtToken generateToken(Authentication authentication) {
        ...
        UserAccessToken userAccessToken = (UserAccessToken)authentication.getPrincipal();
        TokenConnector tokenConnector = userAccessToken.getTokenConnector();
        ...
        String accessToken = Jwts.builder()
                ...
                .claim("connector", tokenConnector)
    ...
    public Authentication getAuthentication(String accessToken){
        ...
        UserAccessToken principal = new UserAccessToken(claims.get("connector"), user);
    ...
    public boolean validateToken(String token) {
        ...
        try {
            ...
            log.info("Expired JWT Token", e);
            throw new BusinessLogicException(BusinessLogicExceptionDefinedReason.INVALID_ACCESS_TOKEN);
        } catch (UnsupportedJwtException e) {
            log.info("Unsupported JWT Token", e);
        } catch (IllegalArgumentException e) {
            log.info("JWT claims string is empty.", e);
